...
import solution.annotation_handlers.PositiveHandler;
...
@DisplayName("\"@Positive\" handler test")
public class PositiveHandlerTest {
    ...
    void handleInvalidType() throws NoSuchFieldException, IllegalAccessException {
        ...
        var field = PositiveHandlerTest.class.getField("invalidList");
    ...
    class ObjectTest {
        ...
        void handleByte() throws NoSuchFieldException, IllegalAccessException {
            ...
            var pathTracker = new StringBuilder();
            var list = (List<?>) field.get(this);
            PositiveHandler.handle(list.get(0), field, errorSet,
                    ValueContainer.OBJECT, ValueType.BYTE, pathTracker);
            assertEquals(0, errorSet.size());
            PositiveHandler.handle(list.get(1), field, errorSet,
                    ValueContainer.OBJECT, ValueType.BYTE, pathTracker);
            assertEquals(0, errorSet.size());
            PositiveHandler.handle(list.get(2), field, errorSet,
                    ValueContainer.OBJECT, ValueType.BYTE, pathTracker);
    ...
    public class FieldTest {
        ...
        public class ByteTest {
            ...
            void handleByte() throws NoSuchFieldException {
                ...
                var pathTracker = new StringBuilder();
                PositiveHandler.handle(this, positive, errorSet,
                        ValueContainer.FIELD, ValueType.BYTE, pathTracker);
                assertEquals(0, errorSet.size());
                PositiveHandler.handle(this, negative, errorSet,
                        ValueContainer.FIELD, ValueType.BYTE, pathTracker);
                assertEquals(1, errorSet.size());
            }
