...
/**
 * Handler for "@Positive" annotation.
 */
public class PositiveHandler {
    ...
    public static void handle(Object object, Field field, Set<ValidationError> errorSet,
        ...
        switch (container) {
            ...
            case FIELD:
                try {
                    handleValue(field.get(object), errorSet,
                            valueType, pathTracker);
    ...
    private static void handleValue(long value, Set<ValidationError> errorSet,
        ...
        if (value <= 0) {
            errorSet.add(new ErrorContent(
                    MessageBuilder.getErrorMessage("Positive"),
